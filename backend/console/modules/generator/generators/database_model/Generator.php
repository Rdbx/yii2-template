...
use console\modules\generator\validators\FilterValidator;
use Yii;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $db = 'db';
    public $ns = 'common\database\table';
    public $tableName;
    ...
    public $databaseNs = "common\\database\\table";
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['db', 'ns', 'tableName', 'modelClass', 'baseClass', 'queryNs', 'queryClass', 'queryBaseClass'], FilterValidator::class, 'filter' => 'trim'],
            [['ns', 'queryNs'], FilterValidator::class,  'filter' => function ($value) { return trim($value, '\\'); }],
...
//            [['modelClass'], 'validateModelClass', 'skipOnEmpty' => false],
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $containModelPath = Yii::getAlias('@' . str_replace('\\', '/', $this->containNs)) . '/' . $modelClassName . '.php';
            $params['ns'] = $this->containNs;
            $params['className'] = $modelClassName;
            $params['baseClass'] = "{$this->databaseNs}\\$modelClassName";
            $files[] = new CodeFile($containModelPath,$this->render('model.php', $params));
    ...
    private function generateManyManyRelations($table, $fks, $relations)
    {
        ...
        foreach ($fks as $pair) {
            ...
            $relations[$table0Schema->fullName][$relationName] = [
                ...
                $className1,
                true,
                "return \$this->hasMany(\$relationClass, $link)->viaTable('"
                    . $this->generateTableName($table->name) . "', $viaLink);",
            ];
            ...
            foreach ($db->getSchema()->getTableSchemas($schemaName) as $table) {
                ...
                foreach ($table->foreignKeys as $refs) {
                    ...
                    $relations[$table->fullName][$relationName] = [
                        ...
                        $refClassName,
                        false,
                        "return \$this->hasOne(\$relationClass, $link);",
                    ];
                    ...
                    $relations[$refTableSchema->fullName][$relationName] = [
                        ...
                        $className,
                        $hasMany,
                        "return \$this->" . ($hasMany ? 'hasMany' : 'hasOne') . "(\$relationClass, $link);",
                    ];
                }
